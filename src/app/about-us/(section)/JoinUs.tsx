      ...
      <div className="z-10 flex h-full w-full flex-col-reverse items-center justify-center gap-4 md:flex-row">
        ...
        >
          ...
          <p className="max-w-[450px] text-center font-[500] leading-[160%] text-[#ffff]">
            ...
            <strong>El Pueblo</strong> invites you to embark on a remarkable
            culinary journey. From expertly crafted flavours to the finest
            hand-selected ingredients, every dish reflects our unwavering
            dedication to excellence. Step into a dining experience where
            tradition meets innovation, and each bite tells a story of passion,
            craft, and exceptional taste.
          </p>
